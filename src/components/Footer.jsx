    ...
    return (
        <>
            <div className={'max-w-[1200px] mx-auto'}>
                    ...
                    <div className={'grid mx-[50px] grid-cols-2 content-center '}>
                        <div className={'w-[400px font-bold] py-9 px-9'}>
                            ...
                            <input type="text" placeholder={'Search '}
                                   className={'bg-whiteColor h-[20px] w-[393px] p-6 rounded-[10px] '}/>
                        </div>
                ...
                <div className={'max-w-[1200px] flex md:flex-col p-[50px] mt-[-20px] bg-[#180D50] mx-auto border-therd border-2 z-30'}>
                    <div className={'grid grid-cols-5 text-whiteColor content-center'}>
